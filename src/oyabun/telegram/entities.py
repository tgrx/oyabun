...
class Message(TelegramBotApiType):
    ...
    author_signature: None | str = Field(None)
    ...
    forward_from_message_id: None | int = Field(None)
    forward_sender_name: None | str = Field(None)
    forward_signature: None | str = Field(None)
    ...
    via_bot: Optional["User"] = Field(None)
